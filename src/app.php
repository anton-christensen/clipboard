...
<div id="app">
    ...
    <ul>
        ...
        <li><a href="?install">Instructions</a>: for getting OS integrations like <code>Ctrl+Win+C/V</code> to copy and
    ...
    <ul>
        <li v-for="item in clipboard">
            <a v-bind:href="'?clip='+item.label" target="_blank"><b>{{ item.label
